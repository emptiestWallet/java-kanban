...
public class Main {
    public static void main(String[] args) {
        ...
        Epic epic1 = new Epic("Подарок другу", "Купить подарок другу на день рождения", TaskStatus.NEW);
        Epic epic2 = new Epic("Путешествие в Японию", "Совершить долгожданную поездку", TaskStatus.NEW);
        ...
        Subtask subtask1ForEpic1 = new Subtask("Выбор подарка", "Подобрать в интернет-магазине подарок",
                TaskStatus.DONE, epic1.getId(), 1L);
        Subtask subtask2ForEpic1 = new Subtask("Вручение подарка",
                "Назначить место встречи и вручить подарок", TaskStatus.IN_PROGRESS, epic1.getId(), 2L);
        Subtask subtask3ForEpic1 = new Subtask("Отпраздновать с другом",
                "Сходить в кафе и отпраздновать ДР", TaskStatus.NEW, epic1.getId(), 3L);
